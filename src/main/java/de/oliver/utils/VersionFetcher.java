...
public class VersionFetcher {
    ...
    public static final String DOWNLOAD_URL = "https://modrinth.com/plugin/fancyholograms/versions";
    private static final String API_URL = "https://api.modrinth.com/v2/project/fancyholograms/version";
